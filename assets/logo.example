...
const getCenterKeyFrames = () => [{ transform: 'scale(1)', fill: '#00D8FF', opacity: 1, offset: 0 },
    { transform: 'scale(.5)', fill: '#00D822', opacity: 0.5, offset: 0.3 },
    { transform: 'scale(.667)', fill: '#f39c12', opacity: 0.667, offset: 0.7875 },
    { transform: 'scale(.6)', fill: '#e74c3c', opacity: 0.6, offset: 1 }
];
...
const getOrbitKeyFrame = () => [{ transform: 'rotate3d(1, -1, 1, 0deg)', stroke: '#00D8FF', opacity: 1, offset: 0 },
    { transform: 'rotate3d(2, 0, 2, 30deg)', stroke: '#00D822', opacity: 0.5, offset: 0.2 },
    { transform: 'rotate3d(3, 1, 3, 60deg)', stroke: '#8e44ad', opacity: 0.667, offset: 0.4 },
    { transform: 'rotate3d(2, 0, 2, 30deg)', stroke: '#f39c12', opacity: 0.6, offset: 0.6 },
    { transform: 'rotate3d(1, -1, 1, 0deg)', stroke: '#e74c3c', opacity: 0.6, offset: 1 }
];
...
export const Logo = () => <div style={{textAlign: 'center'}}>
